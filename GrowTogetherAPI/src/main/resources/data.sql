...
-- ===================== HABITOS ADMIN =====================
INSERT INTO habitos (nombre, descripcion, racha_actual, racha_maxima, usuario_id, activo, frecuencia, tipo, icono, fecha_inicio)
SELECT 'Gimnasio', 'Entrenar 1 hora', 3, 5, id, true, 'DIARIO', 'POSITIVO', 'fitness', CURRENT_DATE - INTERVAL '10 days' FROM usuarios WHERE email = 'admin@growtogether.com';

INSERT INTO habitos (nombre, descripcion, racha_actual, racha_maxima, usuario_id, activo, frecuencia, tipo, icono, fecha_inicio)
SELECT 'Leer 30 minutos', 'Leer al menos 30 minutos al día', 2, 4, id, true, 'DIARIO', 'POSITIVO', 'book', CURRENT_DATE - INTERVAL '10 days' FROM usuarios WHERE email = 'admin@growtogether.com';

INSERT INTO habitos (nombre, descripcion, racha_actual, racha_maxima, usuario_id, activo, frecuencia, tipo, icono, fecha_inicio)
SELECT 'Meditar', 'Meditación de 10 minutos', 1, 3, id, true, 'DIARIO', 'POSITIVO', 'meditation', CURRENT_DATE - INTERVAL '10 days' FROM usuarios WHERE email = 'admin@growtogether.com';

INSERT INTO habitos (nombre, descripcion, racha_actual, racha_maxima, usuario_id, activo, frecuencia, tipo, icono, fecha_inicio)
SELECT 'Dejar de fumar', 'Día sin fumar', 5, 5, id, true, 'DIARIO', 'NEGATIVO', 'smoke', CURRENT_DATE - INTERVAL '10 days' FROM usuarios WHERE email = 'admin@growtogether.com';

-- ===================== HABITOS USUARIO =====================
INSERT INTO habitos (nombre, descripcion, racha_actual, racha_maxima, usuario_id, activo, frecuencia, tipo, icono, fecha_inicio)
SELECT 'Beber agua', 'Beber al menos 2 litros de agua', 1, 2, id, true, 'DIARIO', 'POSITIVO', 'water', CURRENT_DATE - INTERVAL '5 days' FROM usuarios WHERE email = 'usuario@growtogether.com';
